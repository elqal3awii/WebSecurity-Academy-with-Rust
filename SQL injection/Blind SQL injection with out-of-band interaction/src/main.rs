...
fn main() {
    ...
    let url = "https://0aec004004d31fc8810c9346003200a2.web-security-academy.net";
    // change this to your collaborator domain
    let collaborator = "y54zd8pafgsn9ba56832jta7nytphg55.oastify.com";
